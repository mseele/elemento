...
final class Templated_TodoItemElement extends TodoItemElement {
    ...
    private final org.jboss.gwt.elemento.sample.templated.client.ApplicationElement application;
    private final org.jboss.gwt.elemento.sample.common.TodoItemRepository repository;
    private final org.jboss.gwt.elemento.sample.common.TodoItem item;
    private final Element templated_todoitemelement_root_element;

    Templated_TodoItemElement(org.jboss.gwt.elemento.sample.templated.client.ApplicationElement application, org.jboss.gwt.elemento.sample.common.TodoItemRepository repository, org.jboss.gwt.elemento.sample.common.TodoItem item) {
    ...
    @Override
    org.jboss.gwt.elemento.sample.templated.client.ApplicationElement application() {
        return application;
    }
    ...
    @Override
    org.jboss.gwt.elemento.sample.common.TodoItem item() {
        return item;
    }
}
